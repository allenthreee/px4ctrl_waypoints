...
int main(int argc, char *argv[])
{
    ...
    ros::Subscriber odom_sub =
        nh.subscribe<nav_msgs::Odometry>("/Odometry",
                                         100,
    ...
    // ywy add Advertise position setpoint topic (PX4 listens to this for position control)
    fsm.pos_setpoint_pub = nh.advertise<mavros_msgs::PositionTarget>("/mavros/setpoint_raw/local", 10);
